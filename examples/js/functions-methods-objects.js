...
specialRate.textContent = '$' + hotel.offerPrice();		// Write offer price
	...
	function offerExpires(today) {
		...
		dayNames = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thusday', 
		'Friday', 'Saturday'];
		...
		// Create the message
		expiryMsg = 'room rate when you book<br />2 or more nights<br />Offer expires next ';
	...
	elEnds.innerHTML = offerExpires(today);				// Add the expiry messsage
